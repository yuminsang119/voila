...
DUMMY_HOSPITALS: list[dict] = [
    # ── 서울 ────────────────────────────────────────────────────
    {
        ...
        "phone": "02-2072-2114",
        "specialties": ["내과", "외과", "소아과", "산부인과", "신경과", "응급의학과", "이비인후과"],
        "hours": {
            "weekday": "08:30 ~ 17:30",
        ...
        "latitude": 37.5797,
        "longitude": 126.9990,
        "equipment": ["CT", "MRI", "PET-CT", "X-ray", "초음파", "내시경", "후두내시경", "심혈관조영술"],
        "specialists": {"내과": 45, "외과": 30, "소아과": 15, "산부인과": 12, "신경과": 18, "응급의학과": 10, "이비인후과": 12},
    },
    {
        "id": "H00002",
        "name": "강남세브란스병원",
        ...
        "phone": "02-2019-3114",
        "specialties": ["내과", "외과", "정형외과", "피부과", "안과", "이비인후과"],
        "hours": {
            "weekday": "08:30 ~ 17:30",
            "saturday": "08:30 ~ 12:30",
            "sunday": "휴진",
        ...
        "latitude": 37.4881,
        "longitude": 127.0343,
        "equipment": ["CT", "MRI", "PET-CT", "X-ray", "초음파", "내시경", "후두내시경", "맘모그래피"],
        "specialists": {"내과": 38, "외과": 25, "정형외과": 20, "피부과": 8, "안과": 12, "이비인후과": 9},
    },
    {
        "id": "H00003",
        "name": "연세의원",
    ...
    # ── 대전 ────────────────────────────────────────────────────
    {
        ...
        "phone": "042-280-7114",
        "specialties": ["내과", "외과", "소아과", "산부인과", "신경과", "응급의학과", "정형외과", "재활의학과", "이비인후과"],
        "hours": {
            "weekday": "08:30 ~ 17:30",
            "saturday": "08:30 ~ 12:00",
            "sunday": "휴진",
        ...
        "latitude": 36.3219,
        "longitude": 127.4089,
        "equipment": ["CT", "MRI", "PET-CT", "X-ray", "초음파", "내시경", "후두내시경", "심혈관조영술", "방사선치료기"],
        "specialists": {"내과": 30, "외과": 20, "소아과": 12, "산부인과": 10, "신경과": 14, "응급의학과": 8, "정형외과": 15, "재활의학과": 8, "이비인후과": 10},
    },
    {
        "id": "H00102",
        "name": "건양대학교병원",
        ...
        "phone": "042-600-9114",
        "specialties": ["내과", "외과", "소아과", "안과", "피부과", "응급의학과", "이비인후과"],
        "hours": {
            "weekday": "08:30 ~ 17:30",
            "saturday": "08:30 ~ 12:30",
            "sunday": "휴진",
        ...
        "latitude": 36.3028,
        "longitude": 127.3613,
        "equipment": ["CT", "MRI", "PET-CT", "X-ray", "초음파", "내시경", "후두내시경", "안과정밀장비"],
        "specialists": {"내과": 22, "외과": 15, "소아과": 8, "안과": 10, "피부과": 6, "응급의학과": 7, "이비인후과": 8},
    },
    {
        "id": "H00103",
        "name": "대전성모병원",
        ...
        "phone": "042-220-9114",
        "specialties": ["내과", "외과", "산부인과", "소아과", "정형외과", "이비인후과"],
        "hours": {
            "weekday": "08:30 ~ 17:00",
            "saturday": "08:30 ~ 12:00",
            "sunday": "휴진",
        ...
        "latitude": 36.3259,
        "longitude": 127.4268,
        "equipment": ["CT", "MRI", "X-ray", "초음파", "내시경", "후두내시경", "맘모그래피"],
        "specialists": {"내과": 18, "외과": 12, "산부인과": 8, "소아과": 6, "정형외과": 10, "이비인후과": 7},
    },
    {
        "id": "H00104",
        "name": "대전을지대학교병원",
        ...
        "phone": "042-611-3000",
        "specialties": ["내과", "외과", "신경과", "재활의학과", "응급의학과", "이비인후과"],
        "hours": {
            "weekday": "08:30 ~ 17:30",
            "saturday": "08:30 ~ 12:30",
            "sunday": "휴진",
        ...
        "latitude": 36.3505,
        "longitude": 127.3867,
        "equipment": ["CT", "MRI", "X-ray", "초음파", "내시경", "후두내시경", "심혈관조영술"],
        "specialists": {"내과": 20, "외과": 14, "신경과": 10, "재활의학과": 8, "응급의학과": 7, "이비인후과": 8},
    },
    {
        "id": "H00105",
        "name": "대전선병원",
